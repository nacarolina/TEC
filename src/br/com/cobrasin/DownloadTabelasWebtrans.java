...
public class DownloadTabelasWebtrans extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View arg0) {
				...
				if (modweb.contains("TRUE"))
					if (a.getListaCompleta().size() > 0) {
						...
						aviso.setTitle("Sequ�ncial de AIT");
						aviso.setMessage("N�o � possivel atualizar o sequencial com AITs pendentes de transmiss�o");
						aviso.setNeutralButton("OK", null);
						aviso.show();
						return;
					}
				if (InstalImei(imei).equals("ok")) {
					...
					AlertDialog.Builder aviso = new AlertDialog.Builder(
							DownloadTabelasWebtrans.this);
					aviso.setIcon(android.R.drawable.ic_dialog_alert);
					aviso.setTitle("Atualiza��o");
					aviso.setMessage("Erro ao obter sequ�ncial!");
					aviso.setNeutralButton("OK", null);
					aviso.show();
				}
				if (modweb.contains("FALSE")) {
					...
					aviso.setMessage("Voc� est� em modo offline!");
					aviso.setNeutralButton("OK", null);
					aviso.show();
				}
			}
		...
		btTabelaPais.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (modweb.contains("TRUE")) {
					...
					avi.setIcon(android.R.drawable.ic_dialog_alert);
					avi.setTitle("Tabelas do WebTrans");
					avi.setMessage("Deseja baixar tabela de Pa�s?");
					avi.setNeutralButton("N�o", null);
					avi.setPositiveButton("Sim",
							new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog,
										int which) {
									DownloadTabelasWebtrans("Pa�s", "pais");
								}
							});
					avi.show();
				}
		...
		btTabelaEspecies.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (modweb.contains("TRUE")) {
					...
					avi.setIcon(android.R.drawable.ic_dialog_alert);
					avi.setTitle("Tabelas do WebTrans");
					avi.setMessage("Deseja baixar tabela de Esp�cies?");
					avi.setNeutralButton("N�o", null);
					avi.setPositiveButton("Sim",
							new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog,
										int which) {
									DownloadTabelasWebtrans("Esp�cies",
											"especies");
								}
							});
					avi.show();
		...
		lblTotalPais.setText("Pa�s " + quantidadePais + " registros");
		paisdao.close();
		...
		lblTotalEspecies.setText("Esp�cies " + quantidadeEspecies
				+ " registros");
		especiedao.close();
	}
			...
			if (carregaDados("clientes")) {
				...
				for (int nx = 0; nx < jsonArray1.length(); nx++) {
					...
					try {
						...
						// nao � necess�rio validar o munic�pio pois no
						// baseandroid.zip
	...
	public boolean trataAgentes() {
		...
		// dados para comunica��o com o WebTrans
		// pega novamente aqui pois quando a classe � chamada com par�metro "2"
		// n�o carrega os equipamentos
		try {
			// ********************************************
			// 09.08.2012
			//
	...
	public String InstalImei(final String IMEI) {
		String ret = "ok";
