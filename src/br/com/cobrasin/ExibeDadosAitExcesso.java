...
public class ExibeDadosAitExcesso extends Activity {	/*
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			exibe[12] = "NOME:";
			exibe[13] = "PGU:";
			exibe[14] = "DOCUMENTO DE INDENTIFICAÇÃO:";
			exibe[15] = "PPD:--";
		...
		List<br.com.cobrasin.tabela.NotaFiscal> NfLista = NfDAO.GetNotasAit(idAit);
			...
			if(NfLista.size() == 1)
			{
				try {
					...
					exibe[32] = "ENDEREÇO DO EMBARCADOR:"+ Endereco;
					...
					exibe[32] = "ENDEREÇO DO EMBARCADOR:";
			...
			else if(NfLista.size() > 1)
			{
				...
				try {
					...
					exibe[32] = "ENDEREÇO DO TRANSPORTADOR:"+ Endereco;
					...
					exibe[32] = "ENDEREÇO DO TRANSPORTADOR:";
