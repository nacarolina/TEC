...
public class ExibeDadosAitAntesFechamento extends Activity {
	...
	private static final int INVISIBLE = 4;
	 ...
	 public void onCreate(Bundle savedInstanceState) {
	        ...
	        AitDAO aitdao = new AitDAO(ExibeDadosAitAntesFechamento.this);
	        ...
	        try {
		        LogradouroDAO logdao = new LogradouroDAO(ExibeDadosAitAntesFechamento.this);
	        ...
	        try
	        {
		        ...
		        exibe[5]	= "MARCA:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("marca")));
		        exibe[6] 	= "ESPECIE:" + especie ; //c.getString(8);
		        exibe[7]  	= "TIPO:" + tipo;//c.getString(9);
		        exibe[8]  	= "LOGRADOURO:" + desclog;// c.getString(10);
		        exibe[9]  	= "NUMERO:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("logradouronum")));
		        exibe[10]  	= "TIPO:" + ctiplog;//c.getString(12);
		        exibe[11] 	= "NOME:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("nome")));
		        exibe[12] 	= "CPF:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("cpf")));
		        exibe[13] 	= "PGU:" +SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("pgu")));
		        exibe[14] 	= "UF:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("uf")));
		        exibe[15] 	= "OBS:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("observacoes")));
		        exibe[16] 	= "SERIEPDA:" + SimpleCrypto.decrypt(info,  ci.getString(ci.getColumnIndex("seriepda")));
		        exibe[17]   = "MEDIDA ADM:" + medidaadm;
		        
		        exibe[19]   = "EQUIPAMENTO:" +SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("equipamento")));
		        exibe[20]   = "MEDICAO REGISTRADA:" + SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("medicaoreg")));
		        exibe[21]   = "MEDICAO CONSIDERADA:" +  SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("medicaocon")));
		        exibe[22]   = "LIMITE REGULAMENTADO:" +    SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("limitereg")));
	        ...
	        AitEnquadramentoDAO aitenq = new AitEnquadramentoDAO(ExibeDadosAitAntesFechamento.this);
	        ...
	        while (c1.moveToNext())
	        {
				...
				try {
					enquadramento = dao.getLista(SimpleCrypto.decrypt(info, c1.getString(c1.getColumnIndex("codigo"))),ExibeDadosAitAntesFechamento.this);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	        ...
	        exibe[18] 	= "ENQUADRAMENTOS:" + enquads;
