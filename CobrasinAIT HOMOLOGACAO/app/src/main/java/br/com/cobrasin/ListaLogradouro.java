        ...
        if (codLogSelec2.contains("00000")) {
            ...
            if (atual > 0) {
                ...
                try {
                    ...
                    //edNumeroLog.setText(SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("logradouronum"))));

                    int ntipLogSelec = Integer.parseInt(SimpleCrypto.decrypt(info, c.getString(c.getColumnIndex("logradourotipo"))));
                    switch (ntipLogSelec) {
                        case 1:
                            radio0.setChecked(true);
                            break;
