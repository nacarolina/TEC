...
public class AitDAO extends SQLiteOpenHelper {
    ...
    private static final String[] COLS = {"id", "ait", "flag", "agente", "placa", "data", "hora",
            ...
            "viaEntregue","condutorAbordado",
            "medidaadm", "tipoait", "pais", "equipamento", "medicaoreg", "medicaocon", "limitereg", "idwebtrans", "dtEdit", "hrEdit", "tipoinfrator", "flagMedida", "impressao", "sendPdf", "UfVeiculo"};
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sb.append("UfVeiculo TEXT,");
        sb.append("viaEntregue TEXT,");
        sb.append("condutorAbordado TEXT,");
    ...
    public void gravaEquip(Ait aitx) {
        SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait", null, 0);
    ...
    public void gravaUfVeiculo(Ait aitx) {
        SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait", null, 0);
        ContentValues valores = new ContentValues();
        try {
            valores.put("UfVeiculo", SimpleCrypto.encrypt(info, aitx.getUfVeiculo()));
        } catch (Exception e) {
            // TODO Auto-generated catch block
    ...
    public void gravaCondutorAbordado(Ait aitx) {
        try {
            SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait", null, 0);
            ContentValues valores = new ContentValues();
            try {
                valores.put("condutorAbordado", SimpleCrypto.encrypt(info, aitx.getCondutorAbordado()));
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
    ...
    public void gravaViaEntregue(Ait aitx) {
        try {
            SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait", null, 0);
            ContentValues valores = new ContentValues();
            try {
                valores.put("viaEntregue", SimpleCrypto.encrypt(info, aitx.getViaEntregue()));
            } catch (Exception e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
    ...
    public void gravaPostoAgente(Ait aitx) {
        SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait",
                null, 0);
        ContentValues valores = new ContentValues();
        try {
...
//endregion
    ...
    public void alteraInsere(Ait aitx, int tipo)  // 1 altera , 2 insere
    {
        ...
        valores.put("pid", aitx.getPid());
        valores.put("passaporte", aitx.getPassaporte());
        ...
        valores.put("UfVeiculo", aitx.getUfVeiculo());
        ...
        valores.put("viaEntregue", aitx.getViaEntregue());
        valores.put("condutorAbordado", aitx.getCondutorAbordado());
    ...
    public Cursor getAitInfrator(long idAit) {
        SQLiteDatabase s = SQLiteDatabase.openDatabase( Environment.getExternalStorageDirectory().getAbsolutePath() + "/db/ait", null, 0);
        String xidait = "";
        try {
        ...
        Cursor c = null;
        try {
            c = s.rawQuery("SELECT tipoinfrator,ifnull(cpf,'')cpf,ifnull(pgu,'')pgu,ifnull(pid,'')íd,ifnull(passaporte,'')passaporte,ifnull(pid,'')pid from ait where id = ?", new String[]{xidait});
    ...
    public List<Ait> getListaCompleta() {
        ...
        while (c.moveToNext()) {
            ...
            aitx.setIdMunicipio_Agente(c.getString(c.getColumnIndex("viaEntregue")));
            aitx.setIdMunicipio_Agente(c.getString(c.getColumnIndex("condutorAbordado")));
