...
public class CobrasinAitActivity extends Activity 
{
	    			...
	    			*/	
					...
					if ( pdaAtivo.contains("N"))
					{
						...
						if (InstalImei().equals("ok"))
						{
							...
							String StatusPDA = "S";
							if ( j.getString("status").toUpperCase().contains("INATIVO")) StatusPDA = "N";
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // boolean diz = Utilitarios.cancelouAntes("18/05/2012 18:13:20", "19/05/2012 13:10:20");
		...
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost post = new HttpPost("http://189.109.35.10:8080/multas-web/talonario/recuperaDadosVeiculo.action?cliente=8179&placa=AIV7514&user=LOGWEBTRANS8179&password=2EE29B18B07B82DE6DAA4456E5D84F6C&dataSolicitacao=11012018150700");
