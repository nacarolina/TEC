...
public class WebService {
	public String ExecuteScalarQuery(String Query) {
		...
		try {
			...
			HttpPost post = new HttpPost(
					"http://189.109.35.10:9090/JsonWcf/JsonWcfService.svc/ExecuteQuery");
	...
	public JSONArray ExecuteReaderQuery(String Query) {
		...
		try {
			HttpClient client = new DefaultHttpClient();
			HttpPost post = new HttpPost("http://189.109.35.10:9090/JsonWcf/JsonWcfService.svc/ExecuteTestJson");
					//"http://189.109.35.10:9090/WcfPesqSat/wcfPesqSatService.svc/ExecuteQuery");
			...
			Object res=obj.get("ExecuteTestJsonResult");
	...
	public JSONArray ExecuteReaderQuery_PrdMultas(String Query) {
		...
		try {
			HttpClient client = new DefaultHttpClient();
			HttpPost post = new HttpPost("http://189.109.35.10:9090/JsonWcf/JsonWcfService.svc/ExecuteTestJson_PrdMultas");
					//"http://189.109.35.10:9090/WcfPesqSat/wcfPesqSatService.svc/ExecuteQuery");
