...
public class Ait {
		...
		private String logradouro,logradourotipo,nome,cpf,pgu,uf,observacoes,impresso,transmitido,
		seriepda,encerrou,cancelou,motivo,medidaadm,tipoait,pais,
		equipamento,medicaoreg,medicaocon,limitereg,dtEdit,hrEdit,tipoinfrator,flagMedida,impressao,sendPdf,Passaporte,Pid,logradouro2,
		nome_embarcador,cpfCnpj_embarcador,endereco_embarcador,IdMunicipio_embarcador,bairro_embarcador,nome_transportador,cpfCnpj_transportador,endereco_transportador,IdMunicipio_transportador,bairro_transportador,
		limitePermitido_excesso,pesoDeclarado_excesso,excessoConstatado_excesso,tara_excesso,ppd_condutor,Posto_Agente,IdMunicipio_Agente;
